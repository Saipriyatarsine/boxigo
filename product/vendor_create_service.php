...
if( $a == 1  /*
    ...
    $vendor->activation_date=date('Y-m-d H:i:s');
    ...
    $vendor->merchant_status=date('Y-m-d H:i:s');
    $vendor->contract_status=date('Y-m-d H:i:s');
    ...
    $vendor->update_date=date('Y-m-d H:i:s');
